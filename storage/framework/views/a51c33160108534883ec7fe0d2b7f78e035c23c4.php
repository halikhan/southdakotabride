...
<head>
    ...
    <style>
        ...
        @font-face {
            ...
            src: url(<?php echo e(asset('template_assets/font/Poppins-Light.ttf')); ?>);
        }
...
<body>
    ...
    <table
        ...
        <tr>
            <th>
                <img src="<?php echo e($message->embed(asset('website/images/1x/logo.png'))); ?>"
        ...
        <tr>
            <th style="font-family:Cinzel-Medium;color: #EC0169;padding-top: 10px;text-transform: capitalize;">
                <h1>Welcome!<?php echo e($data['name']); ?></h1>
            </th>
        </tr>
        <tr>

            <th style="padding-top: 40px;"><img src="<?php echo e($message->embed(asset('website/images/1x/hand_shake.png'))); ?>" alt=""
...
<?php /**PATH C:\xampp\htdocs\south-dakota-bride\resources\views/website/register/vendor_register.blade.php ENDPATH**/ ?>