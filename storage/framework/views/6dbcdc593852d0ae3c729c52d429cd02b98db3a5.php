<?php $__env->startSection('title', 'South-Dakota-Bride | Vendor-Details'); ?>
                                ...
                                <div class="swiper-slide">
                                    <div class="card mb-4 mt-5">
                                        <div class="Slider_Images_Div">
                                            <img src="<?php echo e(asset('storage/uploads/cms/' . $image ?? '')); ?>">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <?php else: ?>
                            <div class="swiper-slide">
                                <div class="card mb-4 mt-5">
                                    <div class="Slider_Images_Div">
                                        <img
                                            src="<?php echo e(!empty($image) ? asset('storage/uploads/cms/' . $value->image) : asset('storage/uploads/No-gallery.png')); ?>">
                                    </div>
                                </div>
                            </div>
    ...
    <section class="profile wow  animated bounceIn" data-wow-duration="1s" data-wow-delay="0.5s">
        <div class="container text-center  mt-5">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <?php $__currentLoopData = $getvendorDetailsService; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <h1 class="text"><?php echo e($value->name); ?></h1>
                        </div>
                        ...
                        <div class="profile-links pt-3 d-flex justify-content-center">
                            <a href="https://goo.gl/maps/DKt5kZgULkunrP5MA"><?php echo e($value->company); ?></a>

                        </div>
                        <div class="d-flex justify-content-center profile-links pt-2">
                            <div> <a href="tel-123-46-789"><?php echo e($value->contact); ?></a></div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                    <div class="d-flex  justify-content-center pt-3 profile-links">
                        <div class="icons-div">
                            <span><a href="<?php echo e($vendorfacebook[0]->social_media ?? ''); ?>" target="_blank"><i
                                        class="fa-brands fa-facebook-square"></i></a></span>
                        </div>
                        <div class="icons-div">
                            <span><a href="<?php echo e($vendorinstagram[0]->social_media ?? ''); ?>" target="_blank"><i
                                        class="fa-brands fa-instagram"></i></a></span>
                        </div>
                        <div class="icons-div">
                            <span><a href="<?php echo e($vendortwitter[0]->social_media ?? ''); ?>" target="_blank">
                                    <i class="fa-brands fa-twitter"></i></li></a></span>
                        </div>
                        <div class="icons-div">
                            <span><a href="<?php echo e($vendoryoutube[0]->social_media ?? ''); ?>" target="_blank">
                    ...
                    <div class="row for-margin-main-top">
                            ...
                            <?php $__currentLoopData = json_decode($getVendorimages->image); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-lg-4">
                                    <div class="gallery-image">
                                        <img src="<?php echo e(asset('storage/uploads/cms/' . $image ?? '')); ?>" alt="">
                        ...
                        <?php else: ?>
                            <div class="col-lg-4">
                                <div class="gallery-image">
                                    <img
                                        src="<?php echo e(!empty($image) ? asset('storage/uploads/cms/' . $image) : asset('storage/uploads/No-image.jpg')); ?>">
                                </div>
                            </div>
                        <?php endif; ?>
                    ...
                    <div>
                        <div class="art-inner-para wow   fadeInLeft animated" data-wow-duration="1s"
                            ...
                            <h1 class="couple-text wow   fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s"
                                style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s; animation-name: fadeInLeft;">
                                About <?php echo e($value->name); ?> photography</h1>
                            ...
                            <div class="art-inner-para wow   fadeInLeft"
                                ...
                                <p class="art-inner-para wow   fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s"
                                    style="visibility: visible; animation-duration: 1s; animation-delay: 0.5s; animation-name: fadeInLeft;">
                                    <?php echo e($getAboutVendors->aboutvendor ?? ''); ?> </p>
                            </div>
                            <div class="wow animated fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                                <h5>Services</h5>
                                <span><?php echo e($value->get_vednorbusinesscategory->service ?? ''); ?> </span>
                            </div>
                            <div class="wow animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                                <h4 class="pt-5"><?php echo e($value->name); ?> photographer Stoplight</h4>
                                <p><?php echo e($getAboutVendors->stoplight ?? ''); ?></p>

                                <div class="">
                                    <a href="<?php echo e(!empty($getAboutVendors->image)
                                ...
                                <h4 class="pt-5"><?php echo e($value->name); ?> photographer reviews</h4>
                                <p><?php echo e($getAboutVendors->reviews ?? ''); ?></p>
                            </div>
                            <div class="">
                                <a href="<?php echo e(!empty($getAboutVendors->image2)
                ...
                <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                    <div class="row for-margin-main-top">
                        <div class="col-lg-12 mt1 mb1 reviewSendSection">
                            ...
                            <form action=" <?php echo e(route('user_rating', $value->id)); ?>" enctype="multipart/form-data"
                                method="post">
                                <?php echo csrf_field(); ?>
                ...
                <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                    <div class="cstm-width contact-from">
                        <div class="text-center wow   fadeInRight animated" data-wow-duration="1s" data-wow-delay="0.5s"
                            ...
                            <form id="regiterForm" action="<?php echo e(route('vendor_contact', $value->id)); ?>" method="POST" class="from">
                                <?php echo csrf_field(); ?>
                ...
                <div class="tab-pane fade" id="v-pills-review" role="tabpanel" aria-labelledby="v-pills-review-tab">
                    <div class="d-flex justify-content-around mt-5 con-inf-links-location">
                        ...
                        <div>
                            ...
                            <div class="d-flex justify-content-center">
                                <div class="p-2">
                                    <?php if(!empty($getVendorlocations->locations)): ?>
                                        <a href="">
                                            <?php
                                            ...
                                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span><?php echo e($items->location ?? ''); ?> |</span>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="contact-info mt-5 wow animated fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                        <h1><?php echo e($value->name); ?> contact info</h1>
                        <div class="col-lg-8 col-sm-8 mx-auto">
                            <div class="d-flex justify-content-around mt-5 con-inf-links">
                                <div class="d-flex justify-content-center">
                                    ...
                                    <div class="p-2"><a href="tel:123-456-789"><?php echo e($value->contact); ?></a></div>
                                </div>
                                <div>
                                    <div class="d-flex justify-content-center">
                                        <div class="p-2"><i class="fa-solid fa-envelope"></i></div>
                                        <div class="p-2"><a href="mailto:webapparel@mail.com"
                                                target="_blank"><?php echo e($value->email); ?></a></div>
                                    </div>
                                </div>
                                <div>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <div class="p-2"><a href="https://goo.gl/maps/DKt5kZgULkunrP5MA"
                                                target="_blank"><?php echo e($value->company); ?></a></div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('website.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\south-dakota-bride\resources\views/website/vendor_details.blade.php ENDPATH**/ ?>