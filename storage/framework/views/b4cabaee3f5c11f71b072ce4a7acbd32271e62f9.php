    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                ...
                <form class="form theme-form"id="" action="<?php echo e(route("adminVendor-store")); ?>" enctype="multipart/form-data" method="post">
                    <?php echo csrf_field(); ?>
                <div class="card-body">
                    <div class="row">
                        <div class="col">
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\south-dakota-bride\resources\views/adminVendor/create.blade.php ENDPATH**/ ?>