...
<body>
    ...
    style="height:100%;width:60%;margin-left:auto;margin-right: auto;background-repeat: no-repeat;background-size: cover; background-image: url(<?php echo e($message->embed(asset('website/images/1x/bac.png'))); ?>)">
       ...
       <tr>
        <th ><h1 style=" font-family:Cinzel-Medium;color: #EC0169;padding-top: 40px;text-transform: capitalize;">Thank You For Contacting Us!</h1></th>
    </tr>
        <tr >
        ...
        <tr>
            <th><p style=" font-family: Poppins-SemiBold;color: #000;padding-top: 40px;">We have received your contact details.
            <br>
...
<?php /**PATH C:\xampp\htdocs\south-dakota-bride\resources\views/website/usercontact/contact_mail.blade.php ENDPATH**/ ?>