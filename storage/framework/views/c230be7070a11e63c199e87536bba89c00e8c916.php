                                    ...
                                    <?php $__currentLoopData = $getCMS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                           ...
                                           <td class="pageimage">
                                            ...
                                            <img src="<?php echo e(asset('storage/uploads/cms/' . $value->image)); ?>" alt="image" class="pageimage">
                                            <?php else: ?>
                                        ...
                                        <td class="pageimage">
                                            ...
                                            <img src="<?php echo e(asset('storage/uploads/cms/' . $value->image2)); ?>" alt="image" class="pageimage">
                                            <?php else: ?>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo e(route('PageContent_edit', $value->slug)); ?>"><button class="btn btn-success btn-xs for-font-color" type="button" data-original-title="btn btn-danger btn-xs" title="">Edit</button></a>
                                             </td>
                                        </tr>
