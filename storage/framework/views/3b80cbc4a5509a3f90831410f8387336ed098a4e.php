...
<body>
    ...
    style="height:100%;width:60%;margin-left:auto;margin-right: auto;background-repeat: no-repeat;background-size: cover; background-image: url(<?php echo e($message->embed(asset('website/images/1x/bac.png'))); ?>);">
        ...
        <tr>
            <th>
                <h1 style=" font-family:Cinzel-Medium;color: #EC0169;padding-top: 40px;text-transform: capitalize;">Hello,<?php echo e($data['name']); ?><br>Your account has been Approved!</h1>
            </th>
        </tr>
        <tr>
        ...
        <h3 style="margin-left: 50px;">Password : <?php echo e($data['password']); ?></h3>
        </tr>
        <tr>
            <th>
...
<?php /**PATH C:\xampp\htdocs\south-dakota-bride\resources\views/website/vendormail/credentials.blade.php ENDPATH**/ ?>