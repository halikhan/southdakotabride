<?php $__env->startSection('title', 'South-Dakota-Bride | Wedding'); ?>
        ...
        <div class="container pt-5">
            <div class="row ">
                ...
                <div class="col-lg-6 col-sm-6 mb-5 overlay-image-text wow animated fadeInRight" data-wow-duration="1s"
                    ...
                    <form action="<?php echo e(route('wedding')); ?>" method="GET">
                    <div>
    ...
    <section class="Couple-Section mt-5">
        <div class="d-flex justify-content-center">
            <div class="CstDivs container">
                <div class="row mt-5">
                    <?php $__currentLoopData = $getWeddinglist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                    <div class="col-lg-4 col-sm-6 mt-4 wow animated bounceIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="card">
                            
                                <a href="<?php echo e(route('wedding-details', $value->slug)); ?>">
                                <div class="cstm-card-height">
                                    <img src="<?php echo e(asset('storage/uploads/cms/'. $value->image)); ?>" class="card-img-top"
                                        alt="...">
                                </div>
                            </a>
                            <div class="card-body">
                                <h6 class="card-text"><?php echo e($value->groom); ?></h6>
                                <h6 class="card-text">And</h6>
                                <h6 class="card-text"><?php echo e($value->bride); ?></h6>
                            </div>
                        </div>
                    </div>
                ...
                <?php echo e($getWeddinglist->links()); ?>
...
<?php echo $__env->make('website.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\south-dakota-bride\resources\views/website/wedding.blade.php ENDPATH**/ ?>