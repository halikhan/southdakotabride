    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            {{-- <form class="form theme-form"> --}}
                <form class="form theme-form"id="" action="{{ route("contactAdd") }}" enctype="multipart/form-data" method="post">
                    @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input name="phone_number" class="form-control btn-square" id="phone12" type="text" placeholder="tel"  maxlength="14"  pattern="[(][0-9]{3}[)] [0-9]{3}-[0-9]{4}">
                                @error('phone_number')
                                    <p class="help-block" style="color: red">
